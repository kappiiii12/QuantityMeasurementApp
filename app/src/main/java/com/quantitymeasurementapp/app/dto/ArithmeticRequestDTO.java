...
/**
 * Used for add / subtract / divide requests.
 * Example JSON:
 * {
 *   "value1": 3.0, "unit1": "FEET",
 *   "value2": 12.0, "unit2": "INCHES",
 *   "resultUnit": "FEET"          // optional; defaults to unit1
 * }
 */
public class ArithmeticRequestDTO {
    ...
    private String resultUnit;   // optional
